...
document.addEventListener("DOMContentLoaded", function(){
  if (typeof activateTab !== "undefined") {
    ...
    // Tidak ada activateTab → navigasi ke halaman default dan render chart
    navigateTo("pg-dashboard-k");
  }
});
    ...
    document.getElementById("detailBodyStatus").innerHTML = `
        ...
        <div class="capek-gw">
          ${status !== "Sudah Diambil" ? `
            <a href="/sudah_diambil/${id}">
              <button class="btn-konfirmasi">Diambil?</button>
            </a>
          ` : `<p style="color:green;font-weight:600">✅ Sudah Diambil</p>`}
        </div>
    `;
